...
void loop() {
  ...
  float MIC_READING = analogRead(AUDIO_IN);             // If the microphone picks up noise louder than a certain threshold, all the files on the SD card will play
  Serial.println(MIC_READING);
  //Serial.println("playing...");
  if (MIC_READING >= audio_threshold){
